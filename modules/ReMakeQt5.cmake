...
#     modules.
macro(remake_qt5)
  remake_arguments(PREFIX qt5_ LIST COMPONENTS ${qt5_components} LIST REQUIRED ${ARGN})

  if(NOT DEFINED QT5_FOUND)
    if(qt5_components)
      remake_find_package(Qt5 COMPONENTS ${qt5_components} REQUIRED QUIET)
    else(qt5_components)
      message([WARNING]"Use only QtCore as COMPONENTS are undefined")
      remake_find_package(Qt5 COMPONENTS Core REQUIRED QUIET)
    endif(qt5_components)
